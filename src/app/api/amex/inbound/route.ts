...
export async function POST(req: NextRequest) {
  ...
  // only PRESERVES the response body for 4xx responses (200s are dropped
  // from their UI), so we deliberately return 422 here even though this
  // is a "successful" handling. That status also tells CloudMailin not
